...
- The script accepts the following arguments:
  ...
  - **Tolerance Parameters**:
    - `--tol_x`: Tolerance in ?ngströms to expand the docking pocket dimension along the X-axis beyond those defined by P2Rank (default: 0.0).
    - `--tol_y`: Tolerance in ?ngströms to expand the docking pocket dimension along the Y-axis beyond those defined by P2Rank (default: 0.0).
    - `--tol_z`: Tolerance in ?ngströms to expand the docking pocket dimension along the Z-axis beyond those defined by P2Rank (default: 0.0).
  - **Offset Parameters**:
    - `--offset_x`: Offset in ?ngströms to shift the center of the docking grid box along the X-axis (optional, default: 0.0).
    - `--offset_y`: Offset in ?ngströms to shift the center of the docking grid box along the Y-axis (optional, default: 0.0).
    - `--offset_z`: Offset in ?ngströms to shift the center of the docking grid box along the Z-axis (optional, default: 0.0).
...
- **Offset Parameters**:
  ...
  - **Examples**:
    - **Full Offset**:
      ...
      ```
      *Shifts the docking grid center by +1.5 ? in X, -0.5 ? in Y, and +3.0 ? in Z.*
    ...
    - **Partial Offset** (only Y and Z):
      ...
      ```
      *Shifts the docking grid center by -0.5 ? in Y and +3.0 ? in Z. X-axis remains unshifted.*
...
- `--tol_x`, `--tol_y`, `--tol_z`: Docking box tolerances in ?ngströms to expand the docking pocket dimensions along the X, Y, and Z axes respectively (default: 0.0 for each).
- `--offset_x`: Offset in ?ngströms to shift the center of the docking grid box along the X-axis (optional, default: 0.0).
- `--offset_y`: Offset in ?ngströms to shift the center of the docking grid box along the Y-axis (optional, default: 0.0).
- `--offset_z`: Offset in ?ngströms to shift the center of the docking grid box along the Z-axis (optional, default: 0.0).
